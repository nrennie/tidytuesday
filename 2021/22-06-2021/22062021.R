...
p1 <- ggplot(choose_cities, aes(x=year, y=park_pct_city_data/5, fill=city, group=city)) +
  ...
  labs(x="", y="Parkland as percentage\nof city area (%)", title="City parks", 
       subtitle="The percentage of the city area dedicated to parks in the five largest cities in the\nUS has continued to fall since 2012. Until 2020, when the pandemic brought about\nrenewed interest in spending time outdoors.") +
